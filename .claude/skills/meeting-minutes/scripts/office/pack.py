...
Validates with auto-repair, condenses XML formatting, and creates the document.
...
def pack(
    ...
    if validate:
        validators = [DOCXSchemaValidator(input_dir)]
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Pack a directory into a DOCX file"
    )
    parser.add_argument("input_directory", help="Unpacked document directory")
